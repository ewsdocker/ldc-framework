...
echo "   ********************************************"
echo
docker stop ldc-dialog-yad-0.1.0-b3
docker rm ldc-dialog-yad-0.1.0-b3
...
docker rmi ewsdocker/ldc-dialog:yad-0.1.0-b3

# ===========================================================================
#
#    ldc-dialog:yad-0.1.0-b3
#
# ===========================================================================

echo "   ***************************************************"
echo "   ****"
echo "   **** building ewsdocker/ldc-dialog:yad-0.1.0-b3"
echo "   ****"
echo "   ***************************************************"
echo
...
docker build \
  ...
  \
  --file Dockerfile \
-t ewsdocker/ldc-dialog:yad-0.1.0-b3 .
[[ $? -eq 0 ]] ||
 {
 	echo "build ewsdocker/ldc-dialog:yad-0.1.0-b3 failed."
 	exit 1
 }

echo "   ***********************************************"
echo "   ****"
echo "   **** installing ldc-dialog-yad-0.1.0-b3"
echo "   ****"
echo "   ***********************************************"
echo
...
docker run \
  ...
  \
  --name=ldc-dialog-yad-0.1.0-b3 \
ewsdocker/ldc-dialog:yad-0.1.0-b3
[[ $? -eq 0 ]] ||
 {
 	echo "create container ldc-dialog-yad-0.1.0-b3 failed."
 	exit 1
 }
...
echo "   ****************************************************************"
echo "   ****"
echo "   **** ldc-dialog:yad-0.1.0-b3 successfully installed."
echo "   ****"
echo "   ****************************************************************"
echo
echo
