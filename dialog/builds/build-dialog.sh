...
echo "   ********************************************"
echo
docker stop ldc-dialog-dialog-0.1.0-b3
docker rm ldc-dialog-dialog-0.1.0-b3
...
docker rmi ewsdocker/ldc-dialog:dialog-0.1.0-b3

# ===========================================================================
#
#    ldc-dialog:dialog-0.1.0-b3
#
# ===========================================================================

echo "   ***************************************************"
echo "   ****"
echo "   **** building ewsdocker/ldc-dialog:dialog-0.1.0-b3"
echo "   ****"
echo "   ***************************************************"
echo
...
docker build \
  ...
  --file Dockerfile \
  \
  -t ewsdocker/ldc-dialog:dialog-0.1.0-b3  .
[[ $? -eq 0 ]] ||
 {
 	echo "build ewsdocker/ldc-dialog:dialog-0.1.0-b3 failed."
 	exit 1
 }

echo "   ***********************************************"
echo "   ****"
echo "   **** installing ldc-dialog-dialog-0.1.0-b3"
echo "   ****"
echo "   ***********************************************"
echo
...
docker run \
  ...
  \
      ...
      \
      --name=ldc-dialog-dialog-0.1.0-b3 \
    ewsdocker/ldc-dialog:dialog-0.1.0-b3
[[ $? -eq 0 ]] ||
 {
 	echo "create container ldc-dialog-dialog-0.1.0-b3 failed."
 	exit 1
 }
...
echo "   ****************************************************************"
echo "   ****"
echo "   **** ldc-dialog:dialog-0.1.0-b3 successfully installed."
echo "   ****"
echo "   ****************************************************************"
echo
echo
