...
use Application\TVDB\Records\Banner as BannerRecord;

use Library\Utilities\FormatVar;
use Library\XML\LoadXML;

/*
 *		Application\TVDB\Banners is copyright � 2015. EarthWalk Software.
 * 		Licensed under the Academic Free License version 3.0
 *	  	Refer to the file named License.txt provided with the source,
 *		 	or from http://opensource.org/licenses/academic.php
*/
/**
 * Application\TVDB\Banners
 *
 * TVDB Banners API interface
 * @author Jay Wheeler
 * @version 1.0
