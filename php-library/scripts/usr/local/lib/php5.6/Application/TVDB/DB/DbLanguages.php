...
/*
 *		Application\TVDB\DB\DbLanguages is copyright � 2015. EarthWalk Software.
 * 		Licensed under the Academic Free License version 3.0
 *	  	Refer to the file named License.txt provided with the source,
 *		 	or from http://opensource.org/licenses/academic.php
*/
/**
 * Application\TVDB\DB\DbLanguages
 *
 ...
 * @subpackage DB
 */
class DbLanguages extends TVDBLib
{
	/**
	 * __construct
	 *
	...
	{
		parent::__construct('Languages', $dsn, $user, $password, $options);
	}
