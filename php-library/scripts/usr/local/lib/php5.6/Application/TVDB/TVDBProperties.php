...
/*
 *		Application\TVDB\TVDBProperties is copyright � 2015. EarthWalk Software.
 * 		Licensed under the Academic Free License version 3.0
 *      Refer to the file named License.txt provided with the source,
 *         or from http://opensource.org/licenses/academic.php
 */
/**
 * Application\TVDB\TVDBProperties
 *
 * Configuration Properties class for the TVDB application.
 * @author Jay Wheeler
 * @version 1.0
 ...
 * @subpackage TVDB
 */
class TVDBProperties extends Properties
{
	/**
	 * __construct
	 *
	 ...
	 *
	 * Load the TVDB Control.xml configuration file
	 * @throws Exception
	 */
	private function loadConfigProperties($cliDbMap)
	{
		...
		try
		{
			...
			foreach($configTree->TVDB as $property => $value)
			{
