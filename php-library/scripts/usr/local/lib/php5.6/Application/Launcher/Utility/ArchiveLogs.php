...
/*
 *		Launcher\Utility\ArchiveLogs is copyright � 2012, 2015. EarthWalk Software.
...
class ArchiveLogs
{
	 ...
	 */
	public function archiveDirectory($directoryName, $backupDirectory)
	{
		$sourceDirectory = Support::absolutePath($directoryName);
		$backupDirectory = Support::absolutePath($backupDirectory);
		...
		{
			if ($exception->getCode() == Error::code('FileDoesNotExist'))
			{
				return false;
			}
