...
use ApplicationTests\TVDB\LoadEpisodesTest;

/*
 * 		TVDB\DB\DbEpisodesTest is copyright � 2015. EarthWalk Software.
...
/**
 *
 * TVDB\DB\DbEpisodesTest.
 *
 * TVDB Episodes Table class tests.
 * @author Jay Wheeler.
 * @version 1.0
...
class DbEpisodesTest extends LoadEpisodesTest
{
	/**
	 * __construct
	 *
	...
	public function assertionTests($logger=null, $format=null)
	{
		...
		$this->a_insertData($this->a_seriesid, $this->a_dataLink);
