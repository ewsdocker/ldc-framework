...
/*
 * 		Config\ConfigFactory is copyright © 2012, 2013. EarthWalk Software.
 ...
 * @subpackage Config.
 */
class ConfigFactory extends \Library\Factory
{
	/**
	 * newClasses
	 *
	 ...
	 */
	protected	  $newClasses 			= array('ini'		=> 'Library\Config\ConfigINI',
												'xml'		=> 'Library\Config\ConfigXML',
										  		);
	...
	public static function constructFactory($addClasses=array())
	{
		if (! self::$me)
		{
			self::$me = new ConfigFactory($addClasses);
		}
