...
/*
 * 		DBO\DbFactory is copyright � 2012, 2015. EarthWalk Software.
 ...
 * @subpackage DBO.
 */
class DbFactory extends \Library\Factory
{
	/**
	 * newClasses
	 *
	 ...
	 */
	protected	  $newClasses 			= array('mysql'  		=> 'Library\MySql\Db',
												'pdo'			=> 'Library\PDO\Db',
												);
	...
	public static function constructFactory($addClasses=array())
	{
		if (! self::$me)
		{
			self::$me = new DbFactory($addClasses);
		}
