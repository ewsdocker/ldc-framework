...
/*
 * 		DBO\DriverFactory is copyright � 2012, 2015. EarthWalk Software.
 ...
 * @subpackage DBO.
 */
class DriverFactory extends \Library\Factory
{
	/**
	 * newClasses
	 *
	 ...
	 */
	protected	  $newClasses 			= array('mysql'  		=> 'Library\MySql\Driver',
												'pdomysql'		=> 'Library\PDO\DriverMySql',
												);
	...
	public static function constructFactory($addClasses=array())
	{
		if (! self::$me)
		{
			self::$me = new DriverFactory($addClasses);
		}
	 ...
	 * @throws Library\DB\Exception,Library\Factory\Exception
  	 */
