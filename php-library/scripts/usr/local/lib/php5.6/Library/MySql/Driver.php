...
use Library\DBO\DriverAbstract;
use Library\DBO\ParseDsn;
use Library\Error;
use Library\Properties;

/*
 * 		MySql\Driver is copyright � 2012, 2015. EarthWalk Software.
...
class Driver extends DriverAbstract
{
	 ...
	 * queryHandle
	 *
	 * A Query class containing a Result object
	 * @var object $queryHandle
	 */
	 ...
	 * statementHandle
	 *
	 * The Statement class object containing a prepared statement object and result object
	 * @var object $statementHandle
	 */
	 ...
	 * attributes
	 *
	 * A Library\Properties object to manage attributes locally
	 ...
	 * dsnAttributes
	 *
	 * A Library\Properties object to contain DSN options
	 * @var object $dsnAttributes
	 */
	protected $dsnAttributes;
	 ...
	 * @var boolean $transactionInProgress
	 */
	 ...
	 * attributeNames
	 *
	 * Array containing valid attribute names
	...
	{
		$this->dbHandle = new Db($dsn, $user, $password, $options);

		$this->dbLink = $this->dbHandle->dbLink();
