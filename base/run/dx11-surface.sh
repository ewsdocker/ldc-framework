...
echo "   ***********************************************"
echo "   ****"
echo "   **** installing ldc-base-dx11-surface${ldcvers}${ldcextv} container"
echo "   ****"
echo "   ***********************************************"
echo
...
docker run \
  ...
  \
  --name=ldc-base-dx11-surface${ldcvers}${ldcextv} \
ewsdocker/ldc-base:dx11-surface${ldcvers}${ldcextv} 
[[ $? -eq 0 ]] ||
 {
...
echo "   ********************************************"
echo "   ****"
echo "   **** stopping ldc-base-dx11-surface${ldcvers}${ldcextv} daemon"
echo "   ****"
echo "   ********************************************"
echo
...
[[ $? -eq 0 ]] ||
 {
 	echo "stop ldc-base-dx11-surface${ldcvers}${ldcextv} failed."
	exit 3
 }

echo "   ********************************************"
echo "   ****"
echo "   **** removing ldc-base-dx11-surface${ldcvers}${ldcextv} container"
echo "   ****"
echo "   ********************************************"
echo
...
[[ $? -eq 0 ]] ||
 {
 	echo "rm ldc-base-dx11-surface${ldcvers}${ldcextv} failed."
	exit 4
 }
