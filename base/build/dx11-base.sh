...
echo "   ********************************************"
echo
docker rmi ewsdocker/ldc-base:dx11-base-0.1.0-b4

echo "   ********************************************"
echo "   ****"
echo "   **** building ewsdocker/ldc-base:dx11-base-0.1.0-b4"
echo "   ****"
echo "   ********************************************"
echo
docker build \
  ...
  --file Dockerfile \
  \
  -t ewsdocker/ldc-base:dx11-base-0.1.0-b4  .
[[ $? -eq 0 ]] ||
 {
...
echo "   ***********************************************"
echo "   ****"
echo "   **** ldc-base-dx11-base-0.1.0-b4 image created."
echo "   ****"
echo "   ***********************************************"
echo
