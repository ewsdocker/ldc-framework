...
echo "   ********************************************"
echo
docker rm ldc-stack-dcc-0.1.0-b3
...
echo "   ********************************************"
echo
docker rmi ewsdocker/ldc-stack:dcc-0.1.0-b3

echo "   ***************************************************"
echo "   ****"
echo "   **** building ewsdocker/ldc-stack:dcc-0.1.0-b3"
echo "   ****"
echo "   ***************************************************"
echo
...
docker build \
  ...
  \
  --file Dockerfile \
  -t ewsdocker/ldc-stack:dcc-0.1.0-b3 .
[[ $? -eq 0 ]] ||
 {
 	echo "build ewsdocker/ldc-stack:dcc-0.1.0-b3 failed."
 	exit 1
 }

echo "   ***********************************************"
echo "   ****"
echo "   **** installing ldc-stack-dcc-0.1.0-b3"
echo "   ****"
echo "   ***********************************************"
echo
...
docker run \
  ...
  \
  --name=ldc-stack-dcc-0.1.0-b3 \
ewsdocker/ldc-stack:dcc-0.1.0-b3
[[ $? -eq 0 ]] ||
 {
 	echo "build container ldc-stack-dcc-0.1.0-b3 failed."
 	exit 1
 }

echo "   ***********************************************"
echo "   ****"
echo "   **** stopping ldc-stack-dcc-0.1.0-b3 daemon"
echo "   ****"
echo "   ***********************************************"
echo

docker stop ldc-stack-dcc-0.1.0-b3
[[ $? -eq 0 ]] ||
 {
 	echo "stop ldc-stack-dcc-0.1.0-b3 failed."
 }
